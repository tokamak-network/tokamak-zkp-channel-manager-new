/**
 * Step 6: Close Channel (Leader)
 *
 * Tests the channel closing flow:
 * 1. Click Close Channel button
 * 2. Wait for final Groth16 proof generation (up to 10 minutes)
 * 3. Submit verifyFinalBalances transaction
 * 4. Verify channel state changes to "Closed"
 */
...
test.describe("Step 6: Close Channel", () => {
  test("leader should close the channel", async ({ page }) => {
    ...
    // This generates a Groth16 proof for final balance verification
